...
class AddFarmingTipScreen extends StatefulWidget {
  ...
  @override
  State<AddFarmingTipScreen> createState() => _AddFarmingTipScreenState();
}

class _AddFarmingTipScreenState extends State<AddFarmingTipScreen> {
  ...
  Future<void> _saveFarmingTip() async {
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    "Dashboard / Farming Tips / Add New",
                                    style: Theme.of(context)
                                        .textTheme
                                        .titleSmall
                                         ...
                                         children: [
                                           Expanded(
                                             child: _buildTextField(
                                               ...
                                               hintText: 'Enter farming tip in English...',
                                               validator: (value) {
                                           ...
                                           Expanded(
                                             child: _buildTextField(
                                               label: 'Arabic Tip (العربية)*',
                                               controller: _arabicController,
                                               hintText: 'أدخل نصيحة الزراعة بالعربية...',
                                       ...
                                       const SizedBox(height: 20),
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: _buildTextField(
                                                  label: 'German Tip (Deutsch)*',
                                                  controller: _germanController,
                                                  hintText: 'Geben Sie den Landwirtschaftstipp auf Deutsch ein...',
                                                  validator: (value) {
                                                    if (value == null || value.trim().isEmpty) {
                                              ...
                                              Expanded(
                                                child: _buildTextField(
                                                  label: 'Turkish Tip (Türkçe)*',
                                                  controller: _turkishController,
                                                  hintText: 'Türkçe tarım ipucunu girin...',
                                                  validator: (value) {
                                                    if (value == null || value.trim().isEmpty) {
                                         ...
                                         children: [
                                           ...
                                           Expanded(
                                             child: ElevatedButton(
                                               onPressed: _isLoading ? null : _saveFarmingTip,
